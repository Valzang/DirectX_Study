...
D3DXINLINE
D3DXFLOAT16::D3DXFLOAT16( FLOAT f ) : value(0)
{
...
D3DXINLINE
D3DXVECTOR2::D3DXVECTOR2( CONST D3DXFLOAT16 *pf ) : y(0)
{
#ifdef D3DX_DEBUG
    if(!pf)
        return;
...
D3DXINLINE
D3DXVECTOR4::D3DXVECTOR4( CONST D3DXFLOAT16 *pf ) : w(0), y(0), z(0)
{
#ifdef D3DX_DEBUG
    if(!pf)
        return;
...
D3DXINLINE
D3DXQUATERNION::D3DXQUATERNION( CONST D3DXFLOAT16* pf ) : z(0), w(0), y(0)
{
#ifdef D3DX_DEBUG
    if(!pf)
        return;
...
D3DXINLINE
D3DXPLANE::D3DXPLANE( CONST D3DXFLOAT16* pf ) : b(0), c(0), d(0)
{
#ifdef D3DX_DEBUG
    if(!pf)
        return;
...
D3DXINLINE
D3DXCOLOR::D3DXCOLOR( CONST D3DXFLOAT16* pf ) :a(0), b(0), g(0)
{
#ifdef D3DX_DEBUG
    if(!pf)
        return;
